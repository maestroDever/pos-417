<template>
  <div>
    <v-layout flat row justify-center>
      <v-btn round block color="info" large dark @click="dialog = true">Pay With Credit</v-btn>
      ...
      <v-dialog
        ...
        persistent
      >
        <router-link to="/orderComplete">
          <v-card>
            <v-toolbar card dark color="primary">
              <v-toolbar-title>Pay With Credit</v-toolbar-title>
              <v-spacer></v-spacer>
              <v-toolbar-items>
              ...
              <v-layout>
                <v-flex text-xs-center>
                  <v-card>
                    ...
                    <v-flex text-xs-center>
                      <div>
                        <h1 class="headline mb-0">Press Here After Running Card To Finish Order</h1>
                      </div>
                    </v-flex>
                  </v-card>
                </v-flex>
